...
PROJECT_URL = os.environ.get('PROJECT_URL', 'https://app-vcdraa2ybh9gaveplsdgpi.streamlit.app/')   # 项目地址，例如：https://example.com,开启自动保活时或上传节点订阅需要填写
AUTO_ACCESS = os.environ.get('AUTO_ACCESS', 'true').lower() in ('true', 'yes') # 是否开启自动保活，true开启，false关闭，默认关闭
...
UUID = os.environ.get('UUID', 'c10a2ce3-950c-4be1-bc18-77d7f211148a') # 节点和哪吒v1使用的UUID，默认固定值，建议自行生成一个唯一的UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.holoy.qzz.io')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiYjNiMmRhZjE1YjIzYmQ2ZmIzNzZlNGViYTRhYzczYTEiLCJ0IjoiZmQzNzY4NTktNWEzYS00YjE2LWIyOGYtM2RjYzc0MThlZjAxIiwicyI6IlptSmpZVEV4WlRJdFlXWmxaUzAwTlRNekxXSmxPR0V0TWpVeU1Ea3hZV1UyWW1ZeCJ9')      # 固定密钥token或json，留空将使用临时隧道
S5_PORT = os.environ.get('S5_PORT', '4130')          # SOCKS5 端口，默认不启用
HY2_PORT = os.environ.get('HY2_PORT', '4130')        # Hysteria2 端口，默认不启用
...
NAME = os.environ.get('NAME', 'streamlit')               # 节点名称前缀
CHAT_ID = os.environ.get('CHAT_ID', '7627328147')         # Telegram机器人ID，例如1001234567890
BOT_TOKEN = os.environ.get('BOT_TOKEN', '8712829238:AAEkSunL7neEXazQUzTXFaWFbajD2SQEA-Y')     # Telegram机器人Token，例如123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11
